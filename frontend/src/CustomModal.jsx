...
const ModifyUserFormComponent = ({ onClose }) => {
  ...
  const handleFetchUser = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://salessavvy-app-latest.onrender.com/admin/user/getbyid", {
        method: "POST",
        credentials: "include",
        headers: {
  ...
  const handleUpdateUser = async (e) => {
    ...
    const response = await fetch("https://salessavvy-app-latest.onrender.com/admin/user/modify", {
      method: "PUT",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
