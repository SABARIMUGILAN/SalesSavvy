...
const API_BASE_URL = "https://salessavvy-app-latest.onrender.com";
...
const AdminDashboard = () => {
  ...
  const handleDeleteProductSubmit = async ({ productId }) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/admin/products/delete`,
        {
          method: "DELETE",
          credentials: "include",
          headers: {
  ...
  const handleViewUserSubmit = async ({ userId }) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/admin/user/getbyid`,
        {
          method: "POST",
          credentials: "include",
          headers: {
  ...
  const handleModifyUserSubmit = async (data) => {
    if (!data.username) {
      ...
      try {
        ...
        const response = await fetch(
          `${API_BASE_URL}/admin/user/modify`,
          {
            method: "PUT",
            credentials: "include",
            headers: {
  ...
  const handleMonthlyBusiness = async (data) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/admin/business/monthly?month=${data?.month}&year=${data?.year}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
      ...
      console.error(
        "Error fetching monthly business:",
        error
      );
  ...
  const handleDailyBusiness = async (data) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/admin/business/daily?date=${data?.date}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleYearlyBusiness = async (data) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/admin/business/yearly?year=${data?.year}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
      ...
      console.error(
        "Error fetching yearly business:",
        error
      );
  ...
  const handleOverallBusiness = async () => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/admin/business/overall`,
        {
          method: "GET",
          credentials: "include",
          headers: {
      ...
      console.error(
        "Error fetching overall business:",
        error
      );
