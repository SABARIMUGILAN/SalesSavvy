...
export default function OrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch('https://salessavvy-app-latest.onrender.com/api/orders', {
        credentials: 'include',
      });
  ...
  const fetchCartCount = async () => {
    ...
    try {
      const response = await fetch(`https://salessavvy-app-latest.onrender.com/api/cart/items/count?username=${username}`, {
        credentials: 'include',
      });
